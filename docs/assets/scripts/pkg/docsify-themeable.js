...
!(function () {
        ...
        o.open("GET", e),
          ...
          (o.onreadystatechange = function () {
            if (4 === o.readyState) {
              ...
              (o.status < 400 && a(e)) || (0 === o.status && a(e))
                ? c(e, t)
                : s(o, t);
            }
          }),
  ...
  function n(e) {
    var n = /\/\*[\s\S]+?\*\//g,
      ...
      s = Array.apply(null, a.rootElement.querySelectorAll(a.include)).filter(
        function (e) {
          return (
            (t = e),
            (n = a.exclude),
  ...
  function i(t) {
    ...
    function g() {
      ...
      if (e) {
        ...
        return l()
          ? { type: "keyframes", name: r, vendor: t, keyframes: o }
          : c("@keyframes missing '}'");
      }
    }
    function b() {
      if (i(/^@page */))
        return { type: "page", selectors: p() || [], declarations: h() };
    }
    function w() {
      var e = i(
    ...
    function _() {
      ...
      return (
        s.length || c("selector missing"),
        { type: "rule", selectors: s, declarations: i }
      );
    }
    function M(e) {
      ...
      for (
        var n, r = m();
        t.length && (e || "}" !== t[0]) && (n = O() || _());

      )
        n.type && r.push(n), (r = r.concat(m()));
            ...
            if (o.preserveVars || !s || 0 !== s.indexOf("--")) {
              if (-1 !== c.indexOf("var(")) {
                ...
                i !== r.value &&
                  ((i = m(i)),
                  o.preserveVars
                    ? (e.splice(n, 0, { type: a, property: s, value: i }), n++)
                    : (r.value = i));
              }
            } else e.splice(n, 1), n--;
        }
  ...
  function p(e) {
    ...
    function a(e) {
      var r = e.split(",")[0].replace(/[\s\n\t]/g, ""),
        o = (e.match(/(?:\s*,\s*){1}(.*)?/) || [])[1],
        a = Object.prototype.hasOwnProperty.call(t.variables, r)
          ? String(t.variables[r])
          : void 0,
    ...
    if (r) {
      if ("var" === r.pre.slice(-3)) {
        ...
        return s
          ...
          : r.pre.slice(0, -3) + a(r.body) + p(r.post, t);
      }
  ...
  function L() {
    ...
    function s(e) {
      !o.silent && window.console && console.warn("".concat(r).concat(e)),
        o.onWarning(e);
    }
    function c(e) {
    ...
    if (v) {
      ...
      if (
        (!1 === o.watch && S && (S.disconnect(), (S = null)), !o.__benchmark)
      ) {
        ...
        if (h && o.onlyLegacy) {
          ...
          if (o.updateDOM) {
            ...
            Object.keys(o.variables).forEach(function (e) {
              var t = o.variables[e];
              (p = p || t !== getComputedStyle(x).getPropertyValue(e)),
              ...
              n({
                ...
                onSuccess: function (e, t, n) {
                  ...
                  var r = "link" === t.nodeName.toLowerCase(),
                    ...
                    s = o.onSuccess(e, t, n);
                  return (
                    (e = void 0 !== s && !1 === Boolean(s) ? "" : s || e),
                    o.updateURLs && (r || a) && (e = M(e, n)),
                    e
                  );
                },
                  ...
                  if (
                      ...
                      r.forEach(function (t, r) {
                        ...
                        if (t.__cssVars.tree)
                          try {
                            f(
                              t.__cssVars.tree,
                              e({}, o, { variables: w.job, onWarning: s })
                            );
                        ...
                        c && t.setAttribute("data-cssvars", "skip"),
                          t.hasAttribute("data-cssvars-job") ||
                            t.setAttribute("data-cssvars-job", y.job);
                      }),
                    ...
                    o.updateDOM && v && _(o.rootElement),
                      ...
                      o.onComplete(
                        m.join(""),
                        p,
                        JSON.parse(JSON.stringify(w.job)),
                        N() - o.__benchmark
                      ),
                      c(p.length);
                  }
  ...
  function q(e, t) {
    ...
    if (r && o) {
      ...
      if (!a) {
        ...
        for (
          null !== n && s.setAttribute("tabindex", n), e.insertBefore(s, o);
          e.childNodes[0] !== s;
  ...
  function D(e, t) {
    return Number(
      "0." + ((window.Docsify || {}).version || "0").replace(/\./g, "")
    ) < Number("0." + e.replace(/\./g, ""))
      ? t
      : null;
  }
  if (window) {
        ...
        .concat(
          [
            function (e, t) {
              e.init(function () {
                !1 !==
                  ((window.$docsify || {}).themeable || {}).readyTransition &&
            ...
            function (e, t) {
              e.init(function () {
                if (
                  !1 !==
                  ((window.$docsify || {}).themeable || {}).responsiveTables
                ) {
                  var e = (window.$docsify.markdown =
                    ...
                    (t.table =
                      ...
                      function (e, t) {
                        ...
                        try {
                          ...
                          console.log(
                            "Failed to render responsive table: " + e
                          );
                        }
                        return n;
                      });
              ...
              e.ready(function () {
                ...
                e &&
                  e.addEventListener("click", function (r) {
                    (r.target === n || n.contains(r.target)) &&
                      (e.classList.remove("show"), t.focus());
                  }),
                  t &&
