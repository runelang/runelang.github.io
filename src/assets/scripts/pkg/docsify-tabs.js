...
!(function () {
  ...
  function r(t) {
    var o = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      n = (function (t, a) {
        ...
        return t;
      })(t, ".".concat(a.tabButton));
    if (n) {
      var i = n.getAttribute("data-tab"),
        d = document.querySelector(".".concat(a.tabsContainer)),
        b = n.parentNode,
        f = Array.apply(null, b.children).filter(function (t) {
          return s(t, "button");
        }),
        l = b.offsetTop;
      if (
        ...
        n.classList.add(a.tabButtonActive),
        !o)
      ) {
        if (e.persist) {
          var u = (
              d
                ? Array.apply(null, d.querySelectorAll(".".concat(a.tabBlock)))
                : []
            ).indexOf(b),
            y = JSON.parse(sessionStorage.getItem(c.persist)) || {};
          (y[u] = i), sessionStorage.setItem(c.persist, JSON.stringify(y));
        }
        if (e.sync) {
          var p = d
              ? Array.apply(
                  null,
                  d.querySelectorAll(
                    ".".concat(a.tabButton, '[data-tab="').concat(i, '"]')
                  )
                )
              : [],
            m = JSON.parse(sessionStorage.getItem(c.sync)) || [];
          p.forEach(function (t) {
            r(t, !0);
          }),
            window.scrollBy(0, 0 - (l - b.offsetTop)),
            m.indexOf(i) > 0 && m.splice(m.indexOf(i), 1),
            0 !== m.indexOf(i) &&
              (m.unshift(i), sessionStorage.setItem(c.sync, JSON.stringify(m)));
        }
      }
    }
  }
  ...
  window &&
    ...
    (window.$docsify.tabs.version = "1.6.2"),
    (e.tabComments || e.tabHeadings) &&
      (window.$docsify.plugins = [].concat(
        window.$docsify.plugins || [],
        function (i, d) {
          var b = !1;
          i.beforeEach(function (c) {
            return (
                    ...
                    var r = c.match(o.codeMarkup) || [],
                      ...
                      l = function () {
                        var r,
                          ...
                          u = b[2],
                          y = b[4],
                          p = e.tabComments && o.tabCommentMarkup.test(n),
                          m = e.tabHeadings && o.tabHeadingMarkup.test(n),
                          h = "",
                          g = "";
                        if (p || m) {
                          (h = "\x3c!-- "
                          ...
                          for (
                            ...
                            (r =
                              (e.tabComments
                                ? o.tabCommentMarkup.exec(n)
                                : null) ||
                              (e.tabHeadings
                                ? o.tabHeadingMarkup.exec(n)
                                : null));

                          )
                            v();
                        }
                        (n = (n = n.replace(u, function () {
                          return h;
                        })).replace(y, function () {
                          return g;
                        })),
            ...
            i.doneEach(function () {
              ...
              b &&
                ((o = (t = document.querySelector(".".concat(a.tabsContainer)))
                  ...
                  : []),
                (r = JSON.parse(sessionStorage.getItem(c.persist)) || {}),
                (i = JSON.parse(sessionStorage.getItem(c.sync)) || []),
                n(),
                o.forEach(function (t, o) {
                  var c = Array.apply(null, t.children).filter(function (t) {
                    return s(t, ".".concat(a.tabButtonActive));
                  })[0];
                  c ||
                    (e.sync &&
                      i.length &&
                    ...
                    !c &&
                      e.persist &&
                      (c = Array.apply(null, t.children).filter(function (t) {
                        return s(
                          t,
                          "."
                            .concat(a.tabButton, '[data-tab="')
